            ...
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <form action="{{ url('/skills/'.$skill->id) }}" enctype="multipart/form-data" method="post"  class="form-horizontal">
                      @csrf
                      @method('PUT')
                    <div class="control-group">
                      <label class="control-label">Skill Name :</label>
                      <div class="controls">
                        <input type="text" class="span11" placeholder=" name" name="name" value="{{ $skill->name }}"/>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" class="span11" placeholder=" name" name="progress" value="{{ $skill->progress }}"/>
                        </div>
                      </div>
