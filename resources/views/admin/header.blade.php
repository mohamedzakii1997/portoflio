...
<link rel="stylesheet" href="{{ asset('backendcss/colorpicker.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/datepicker.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/uniform.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/select2.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/matrix-style.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/matrix-media.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/bootstrap-wysihtml5.css') }}" />
<link rel="stylesheet" href="{{ asset('backendcss/flaticon.css') }}" />
